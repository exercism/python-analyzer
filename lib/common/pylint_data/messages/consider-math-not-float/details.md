...
Regarding performance, float(\"nan\") and float(\"inf\") are slower than
their counterpart math.inf and math.nan by a factor of 4 after the
...
So the decision depends on how and how often you need to use it and what
matter to you.
