...
your code, but your pylint configuration or the way you launch pylint
needs to be modified.

For example, this message would be raised when invoking pylint with
`pylint --unknown-option=yes test.py`. Or you might be launching pylint
...
This warning was released in pylint 2.14: bad options were silently
failing before.
